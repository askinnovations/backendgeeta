   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="editCustomerModalLabel">✏ Edit Ledger Master</h5>
         ...
         <form id="editCustomerForm" method="POST">
            ...
            <div class="modal-body">
               ...
               <div class="mb-3">
                  <label class="form-label">Name Of Deductor</label>
                  <input type="text" name="deductor" id="editDeductor" class="form-control" required>
               </div>
               <div class="mb-3">
   ...
   document.addEventListener("DOMContentLoaded", function () {
       document.querySelectorAll(".edit-btn").forEach(function (btn) {
           btn.addEventListener("click", function () {
               ...
               let Deductor  = row.children[4].innerText.trim();
               let addressData = row.children[5].innerText.trim(); // Now 4th index after removing GST
               ...
               document.getElementById("editDeductor").value = Deductor;
